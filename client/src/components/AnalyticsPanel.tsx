...
function AllocationDonut() {
  ...
  const CustomTooltip = ({ active, payload }: any) => {
    if (active && payload?.length) {
      ...
      return (
        <div className="bg-[oklch(0.24_0.03_50)] border border-[oklch(1_0_0/10%)] rounded-lg p-2.5 shadow-xl">
...
export default function AnalyticsPanel() {
  return (
    <div className="flex flex-col h-full bg-[oklch(0.20_0.03_50)]">
      <div className="px-4 py-3 border-b border-[oklch(1_0_0/8%)]">
        <h2 className="font-serif text-base font-semibold text-foreground flex items-center gap-2">
          <Activity className="w-4 h-4 text-[oklch(0.66_0.10_55)]" />
          Portfolio Analytics
        </h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
        <Tabs defaultValue="allocation" className="h-full">
          <TabsList className="w-full bg-[oklch(1_0_0/4%)] rounded-none border-b border-[oklch(1_0_0/8%)] px-2 justify-start gap-0 h-10">
            <TabsTrigger value="allocation" className="text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-[oklch(0.66_0.10_55)] data-[state=active]:bg-transparent px-2 sm:px-3 h-10">
              <PieIcon className="w-3 h-3 sm:mr-1.5" />
              <span className="hidden sm:inline">Allocation</span>
            </TabsTrigger>
            <TabsTrigger value="scenarios" className="text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-[oklch(0.66_0.10_55)] data-[state=active]:bg-transparent px-2 sm:px-3 h-10">
              <BarChart3 className="w-3 h-3 sm:mr-1.5" />
              <span className="hidden sm:inline">Scenarios</span>
            </TabsTrigger>
            <TabsTrigger value="growth" className="text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-[oklch(0.66_0.10_55)] data-[state=active]:bg-transparent px-2 sm:px-3 h-10">
              <TrendingUp className="w-3 h-3 sm:mr-1.5" />
              <span className="hidden sm:inline">Growth</span>
            </TabsTrigger>
            <TabsTrigger value="detail" className="text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-[oklch(0.66_0.10_55)] data-[state=active]:bg-transparent px-2 sm:px-3 h-10">
              <Activity className="w-3 h-3 sm:mr-1.5" />
              <span className="hidden sm:inline">Detail</span>
            </TabsTrigger>
            <TabsTrigger value="compare" className="text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-[oklch(0.66_0.10_55)] data-[state=active]:bg-transparent px-2 sm:px-3 h-10">
