...
const SCENARIO_CONFIG = {
  bear: { label: 'Bear Case', color: 'oklch(0.50 0.12 22)', bg: 'oklch(0.50 0.12 22 / 8%)', icon: TrendingDown },
  base: { label: 'Base Case', color: 'oklch(0.66 0.10 55)', bg: 'oklch(0.66 0.10 55 / 8%)', icon: Minus },
  bull: { label: 'Bull Case', color: 'oklch(0.50 0.09 140)', bg: 'oklch(0.50 0.09 140 / 8%)', icon: TrendingUp },
};
    ...
    <div className={className}>
      ...
      <div className="relative flex items-center">
        ...
        <Input
          ...
          step={step}
          className={`h-8 text-xs bg-[oklch(1_0_0/5%)] border-[oklch(1_0_0/10%)] focus:border-[oklch(0.66_0.10_55/34%)] text-right
...
function MiniGrowthChart({ proj, years }: { proj: StockProjections; years: number }) {
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload?.length) {
      return (
        <div className="bg-[oklch(0.24_0.03_50)] border border-[oklch(1_0_0/10%)] rounded-lg p-2 shadow-xl text-[10px]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="relative">
              ...
              {projData.niGrowthAutoSet && (
                <span className="absolute top-0 right-0 text-[9px] font-bold px-1 py-0.5 rounded bg-[oklch(0.66_0.10_55/12%)] text-[oklch(0.66_0.10_55)] border border-[oklch(0.66_0.10_55/20%)] leading-none">
                  AUTO
                </span>
              )}
            </div>
...
export default function ProjectionDrawer({ mobileMode = false }: { mobileMode?: boolean }) {
  ...
  return (
    <div className={mobileMode
      ? 'flex flex-col h-full bg-[oklch(0.21_0.03_50)]'
      : 'fixed inset-y-0 right-0 w-[480px] bg-[oklch(0.21_0.03_50)] border-l border-[oklch(1_0_0/8%)] shadow-2xl z-50 flex flex-col'
    }>
      {/* ── Header ──────────────────────────────────────────────────────── */}
      ...
      {/* ── Live Financials Row ─────────────────────────────────────────────────── */}
      <div className="px-4 py-3 border-b border-[oklch(1_0_0/8%)] bg-[oklch(0.22_0.03_50)]">     {/* Price + Valuation Method */}
        <div className="grid grid-cols-3 gap-3 mb-3">
          ...
          <div>
            ...
            >
              ...
              <SelectContent className="bg-[oklch(0.24_0.03_50)] border-[oklch(1_0_0/10%)]">
      ...
      <div>
        <div className="p-4">
          <div className="mb-3 p-2.5 rounded-lg bg-[oklch(0.66_0.10_55/4%)] border border-[oklch(0.66_0.10_55/12%)]">
            <p className="text-[10px] text-[oklch(0.66_0.10_55)] font-medium">
