  ...
  return (
    <div
      ...
      className={`flex flex-col items-center justify-center h-48 rounded-xl border-2 border-dashed transition-all duration-200
        ${isOver
          ? 'border-[oklch(0.72_0.17_162)] bg-[oklch(0.72_0.17_162/8%)]'
          : 'border-[oklch(1_0_0/12%)] bg-[oklch(1_0_0/2%)]'
        }`}
    >
      <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 transition-colors
        ${isOver ? 'bg-[oklch(0.72_0.17_162/20%)]' : 'bg-[oklch(1_0_0/5%)]'}`}>
        <Plus className={`w-6 h-6 ${isOver ? 'text-[oklch(0.72_0.17_162)]' : 'text-muted-foreground'}`} />
      </div>
    ...
    >
          ...
          {editing ? (
            <div className="flex items-center gap-1">
              <Input
                ...
                className="w-20 h-7 text-xs text-right bg-[oklch(1_0_0/8%)] border-[oklch(0.72_0.17_162/50%)]"
              />
            ...
            <button
              ...
              className="text-right hover:text-[oklch(0.72_0.17_162)] transition-colors"
            >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="h-7 w-7 p-0 text-muted-foreground hover:text-[oklch(0.72_0.17_162)]"
      ...
      <div className="px-3 pb-3">
        <Slider
          ...
          max={100}
          step={sliderStep}
          className="[&_[role=slider]]:bg-[oklch(0.72_0.17_162)] [&_[role=slider]]:border-[oklch(0.72_0.17_162)] [&_.bg-primary]:bg-[oklch(0.72_0.17_162)]"
        />
      </div>
    </div>
  );
...
function CashRow({ cashPct, totalCapital, allocationMode }: {
  ...
  return (
    <div className="rounded-lg border border-[oklch(0.72_0.17_162/20%)] bg-[oklch(0.72_0.17_162/5%)] p-3">
      <div className="flex items-center gap-2 mb-2">
        <Wallet className="w-4 h-4 text-[oklch(0.72_0.17_162)] shrink-0" />
        ...
        <div className="text-right">
          <div className="text-sm font-semibold font-mono text-[oklch(0.72_0.17_162)]">
            {allocationMode === 'percentage'
              ? `${cashPct.toFixed(1)}%`
              : formatCurrency(dollarValue)
            }
      ...
      <Slider
        ...
        max={100}
        step={sliderStep}
        className="[&_[role=slider]]:bg-[oklch(0.72_0.17_162)] [&_[role=slider]]:border-[oklch(0.72_0.17_162)] [&_.bg-primary]:bg-[oklch(0.72_0.17_162/60%)]"
      />
    </div>
  );
}
  ...
  return (
    <div
      className={`group flex items-center gap-1.5 px-3 py-1.5 rounded-t-lg border-b-2 cursor-pointer transition-all text-sm shrink-0
        ${isActive
          ? 'border-[oklch(0.72_0.17_162)] bg-[oklch(1_0_0/5%)] text-foreground'
      ...
      {editing ? (
        <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
          <Input
            ...
            className="h-6 w-28 text-xs bg-[oklch(1_0_0/8%)] border-[oklch(0.72_0.17_162/50%)]"
          />
        </div>
      ) : (
        <>
          ...
          {isActive && (
            <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity" onClick={(e) => e.stopPropagation()}>
              <button
                ...
                className="p-0.5 rounded hover:text-[oklch(0.72_0.17_162)]"
              >
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4">
        ...
        <Button
          ...
          className="bg-[oklch(0.72_0.17_162)] text-[oklch(0.12_0.02_220)] hover:bg-[oklch(0.78_0.15_162)] font-semibold"
        >
    ...
    <div className="flex flex-col h-full">
        ...
        <div className="flex items-center gap-0 px-4 pt-3 border-b border-[oklch(1_0_0/8%)] overflow-x-auto">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1.5 text-xs text-muted-foreground hover:text-[oklch(0.72_0.17_162)] shrink-0 ml-1"
          >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1.5 text-xs text-muted-foreground hover:text-[oklch(0.72_0.17_162)] shrink-0"
                >
        ...
        {activePortfolio && (
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="px-4 py-3 border-b border-[oklch(1_0_0/8%)] bg-[oklch(0.15_0.02_220)]">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 sm:flex-wrap">
                {/* Total Capital */}
                <div className="flex items-center gap-2">
                  <DollarSign className="w-4 h-4 text-[oklch(0.72_0.17_162)] shrink-0" />
                  <div>
                    ...
                    {capitalEditing ? (
                      <Input
                        ...
                        className="h-7 w-32 text-sm font-mono bg-[oklch(1_0_0/8%)] border-[oklch(0.72_0.17_162/50%)]"
                      />
                    ) : (
                      <button
                        onClick={() => { setCapitalInput(''); setCapitalEditing(true); }}
                        className="text-lg font-semibold font-mono text-foreground hover:text-[oklch(0.72_0.17_162)] transition-colors"
                      >
                ...
                <div className="shrink-0 ml-auto flex items-center gap-3">
                  {hasStocks && Math.abs(totalAllocated - 100) > 0.5 && (
                    <button
                      ...
                      className="text-[10px] px-2 py-1 rounded bg-[oklch(0.72_0.17_162/15%)] text-[oklch(0.72_0.17_162)] border border-[oklch(0.72_0.17_162/30%)] hover:bg-[oklch(0.72_0.17_162/25%)] transition-colors font-medium"
                    >
                      Normalize
                    </button>
                  )}
                  <div>
                    ...
                    <p className={`font-mono text-sm font-semibold ${isOver100 ? 'text-destructive' : hasStocks && Math.abs(totalAllocated - 100) < 0.5 ? 'text-[oklch(0.55_0.18_200)]' : hasStocks ? 'text-[oklch(0.72_0.17_162)]' : 'text-muted-foreground'}`}>
  ...
  return (
    <div
      ...
      className={`h-12 rounded-lg border-2 border-dashed flex items-center justify-center text-xs text-muted-foreground transition-all duration-150
        ${isOver ? 'border-[oklch(0.72_0.17_162)] bg-[oklch(0.72_0.17_162/8%)] text-[oklch(0.72_0.17_162)]' : 'border-[oklch(1_0_0/8%)]'}`}
    >
