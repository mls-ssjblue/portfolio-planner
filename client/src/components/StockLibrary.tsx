  ...
  return (
    <div
      ...
      className={`group relative flex items-center gap-2.5 p-2.5 rounded-lg border transition-all duration-150 select-none touch-auto
        ${isInPortfolio
          ? 'border-[oklch(0.65_0.13_162/25%)] bg-[oklch(0.65_0.13_162/6%)]'
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          {isInPortfolio && (
            <span className="text-[10px] text-[oklch(0.65_0.13_162)] font-medium">✓</span>
          )}
        </div>
  ...
  return (
    ...
    >
      <div className="shrink-0">
        <Plus className="w-3 h-3 text-muted-foreground opacity-40 group-hover:opacity-80 group-hover:text-[oklch(0.65_0.13_162)]" />
      </div>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[9px] text-muted-foreground/50 group-hover:text-[oklch(0.65_0.13_162/60%)] transition-colors">+Add</span>
      </div>
    </div>
  );
}
...
export default function StockLibrary() {
  ...
  return (
    <div className="flex flex-col h-full bg-[oklch(0.20_0.02_220)] border-r border-[oklch(1_0_0/8%)]">
      {/* Header */}
      <div className="p-4 border-b border-[oklch(1_0_0/8%)]">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <TrendingUp className="w-4 h-4 text-[oklch(0.65_0.13_162)]" />
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-8 h-8 text-xs bg-[oklch(1_0_0/4%)] border-[oklch(1_0_0/8%)] focus:border-[oklch(0.65_0.13_162/42%)]"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
