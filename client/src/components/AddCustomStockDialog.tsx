    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-muted-foreground hover:text-[oklch(0.66_0.10_55)] hover:bg-[oklch(0.66_0.10_55/4%)] border border-[oklch(1_0_0/8%)] hover:border-[oklch(0.66_0.10_55/20%)] transition-all"
        >
      ...
      <DialogContent className="bg-[oklch(0.21_0.03_50)] border-[oklch(1_0_0/10%)] text-foreground max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-serif text-lg font-semibold text-foreground flex items-center gap-2">
            <Plus className="w-4 h-4 text-[oklch(0.66_0.10_55)]" />
            Add Custom Stock
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 mt-2">
          ...
          <div className="p-3 rounded-lg bg-[oklch(0.66_0.10_55/4%)] border border-[oklch(0.66_0.10_55/12%)]">
            <p className="text-[11px] text-[oklch(0.66_0.10_55)]">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <Button
              size="sm"
              className="flex-1 h-9 text-sm bg-[oklch(0.66_0.10_55)] hover:bg-[oklch(0.60_0.08_55)] text-[oklch(0.1_0_0)]"
